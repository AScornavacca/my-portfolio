...
export const Banner = () => {
    ...
    const toRotate = ["Web Developer", "SQL", "C++", "React"];
      ...
      <Container>
        <Row className="align-items-center">
          <Col xs={12} md={6} xl={7}>
            ...
            <p>I am 24 years old and I started my studies in web developer a year ago.
               I am a very curious person and I like to learn new technologies. I learned languages like C#,.Net and React in a self-taught way.
